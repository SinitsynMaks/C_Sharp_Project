namespace ClientStellaDesktopManager
{
	partial class FClockSettings
	{
		...
		private void InitializeComponent()
		{
			...
			this.comboBox1.Location = new System.Drawing.Point(86, 9);
			...
			// textBox2
			// 
			this.textBox2.Location = new System.Drawing.Point(231, 44);
			...
			this.groupBox1.Text = "Режимы работы часов";
			// 
			// dataGridView1
			// 
			...
			this.Name = "FClockSettings";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Настройки отображения часов";
